...
from utils.data import infer_data
...
class DGCNNClassifier(CNNBasedClassifiers):
    ...
    def __init__(self, **kwargs):
        ...
        self.batch_size = 1 # only support batch size 1 for inferencing
        self.cuda = kwargs.get("cuda", False)
        self.model_path = kwargs.get("model_path", None)

        self.args = namespace.Dgcnn_Namespace # contains the arguments that are passed for the DGCNN model
